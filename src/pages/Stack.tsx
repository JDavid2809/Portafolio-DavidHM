    ...
    const technologies = [
    { name: "Tailwind CSS", logo: BASE_URL + "Tailwind_CSS_Logo.png" },
    { name: "CSS", logo: BASE_URL + "Css.webp" },
    { name: "Bootstrap", logo: BASE_URL + "Bootstrap.png" },
    { name: "React", logo: BASE_URL + "React.png" },
    { name: "Next.js", logo: BASE_URL + "next-js.png" },
    { name: "TypeScript", logo: BASE_URL + "Typescript_Logo.png" },
    { name: "Node.js", logo: BASE_URL + "Node.js_logo.png" },
    { name: "Firebase", logo: BASE_URL + "Firebase.png" },
    { name: "MySQL", logo: BASE_URL + "MySQL.png" },
    { name: "Prisma", logo: BASE_URL + "Prisma.png" },
    { name: "Git", logo: BASE_URL + "Git.png" },
    { name: "GitHub", logo: BASE_URL + "GitHub.png" },
]
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10 flex flex-col items-center gap-4">
                                            <div className="w-20 h-20 rounded-2xl bg-gray-50 flex items-center justify-center p-4 group-hover:bg-[#0096C7]/10 transition-colors">
                                                <img
                                                    src={tech.logo || "/Portafolio-DavidHM/placeholder.svg"}
                                                    alt={tech.name}
